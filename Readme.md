...
# Configuration Script – GNT1 - Rev. A

This **Configuration** script is designed for the **GNT1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – GNT1 Rev. A

Este script de **Configuration** está diseñado para el modelo **GNT1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
